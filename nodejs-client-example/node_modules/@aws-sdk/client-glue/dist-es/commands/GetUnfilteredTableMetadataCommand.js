...
import { GetUnfilteredTableMetadataRequestFilterSensitiveLog, GetUnfilteredTableMetadataResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetUnfilteredTableMetadataCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetUnfilteredTableMetadataCommand.getEndpointParameterInstructions()));
