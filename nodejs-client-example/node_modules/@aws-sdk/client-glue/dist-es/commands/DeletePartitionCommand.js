...
import { DeletePartitionRequestFilterSensitiveLog, DeletePartitionResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeletePartitionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeletePartitionCommand.getEndpointParameterInstructions()));
