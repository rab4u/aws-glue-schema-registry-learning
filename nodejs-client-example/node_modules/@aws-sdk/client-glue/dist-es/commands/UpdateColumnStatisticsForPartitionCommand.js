...
import { UpdateColumnStatisticsForPartitionRequestFilterSensitiveLog, UpdateColumnStatisticsForPartitionResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateColumnStatisticsForPartitionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateColumnStatisticsForPartitionCommand.getEndpointParameterInstructions()));
