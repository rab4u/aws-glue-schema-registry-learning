...
import { DeleteColumnStatisticsForTableRequestFilterSensitiveLog, DeleteColumnStatisticsForTableResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteColumnStatisticsForTableCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteColumnStatisticsForTableCommand.getEndpointParameterInstructions()));
