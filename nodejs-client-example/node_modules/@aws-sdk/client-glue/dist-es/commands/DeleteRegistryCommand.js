...
import { DeleteRegistryInputFilterSensitiveLog, DeleteRegistryResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteRegistryCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteRegistryCommand.getEndpointParameterInstructions()));
