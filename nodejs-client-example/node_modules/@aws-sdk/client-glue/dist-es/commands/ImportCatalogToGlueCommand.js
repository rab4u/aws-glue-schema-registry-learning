...
import { ImportCatalogToGlueRequestFilterSensitiveLog, ImportCatalogToGlueResponseFilterSensitiveLog, } from "../models/models_1";
...
export class ImportCatalogToGlueCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ImportCatalogToGlueCommand.getEndpointParameterInstructions()));
