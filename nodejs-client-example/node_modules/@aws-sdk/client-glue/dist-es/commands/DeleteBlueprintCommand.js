...
import { DeleteBlueprintRequestFilterSensitiveLog, DeleteBlueprintResponseFilterSensitiveLog, } from "../models/models_1";
import { deserializeAws_json1_1DeleteBlueprintCommand, serializeAws_json1_1DeleteBlueprintCommand, } from "../protocols/Aws_json1_1";
export class DeleteBlueprintCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteBlueprintCommand.getEndpointParameterInstructions()));
