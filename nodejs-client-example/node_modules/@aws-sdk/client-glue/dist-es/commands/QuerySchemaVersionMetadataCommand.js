...
import { QuerySchemaVersionMetadataInputFilterSensitiveLog, QuerySchemaVersionMetadataResponseFilterSensitiveLog, } from "../models/models_2";
...
export class QuerySchemaVersionMetadataCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, QuerySchemaVersionMetadataCommand.getEndpointParameterInstructions()));
