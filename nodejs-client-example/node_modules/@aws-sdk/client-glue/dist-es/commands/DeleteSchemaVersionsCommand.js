...
import { DeleteSchemaVersionsInputFilterSensitiveLog, DeleteSchemaVersionsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteSchemaVersionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteSchemaVersionsCommand.getEndpointParameterInstructions()));
