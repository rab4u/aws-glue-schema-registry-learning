...
import { DeleteCustomEntityTypeRequestFilterSensitiveLog, DeleteCustomEntityTypeResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteCustomEntityTypeCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteCustomEntityTypeCommand.getEndpointParameterInstructions()));
