...
import { UpdateCrawlerScheduleRequestFilterSensitiveLog, UpdateCrawlerScheduleResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateCrawlerScheduleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateCrawlerScheduleCommand.getEndpointParameterInstructions()));
