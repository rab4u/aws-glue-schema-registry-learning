...
import { RegisterSchemaVersionInputFilterSensitiveLog, RegisterSchemaVersionResponseFilterSensitiveLog, } from "../models/models_2";
...
export class RegisterSchemaVersionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, RegisterSchemaVersionCommand.getEndpointParameterInstructions()));
