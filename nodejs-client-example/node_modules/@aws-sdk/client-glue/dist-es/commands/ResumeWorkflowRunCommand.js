...
import { ResumeWorkflowRunRequestFilterSensitiveLog, ResumeWorkflowRunResponseFilterSensitiveLog, } from "../models/models_2";
...
export class ResumeWorkflowRunCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ResumeWorkflowRunCommand.getEndpointParameterInstructions()));
