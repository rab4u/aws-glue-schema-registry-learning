...
import { StopWorkflowRunRequestFilterSensitiveLog, StopWorkflowRunResponseFilterSensitiveLog, } from "../models/models_2";
...
export class StopWorkflowRunCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StopWorkflowRunCommand.getEndpointParameterInstructions()));
