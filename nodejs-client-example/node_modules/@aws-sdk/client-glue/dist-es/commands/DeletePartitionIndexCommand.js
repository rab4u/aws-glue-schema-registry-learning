...
import { DeletePartitionIndexRequestFilterSensitiveLog, DeletePartitionIndexResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeletePartitionIndexCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeletePartitionIndexCommand.getEndpointParameterInstructions()));
