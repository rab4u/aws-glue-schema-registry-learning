...
import { GetWorkflowRunPropertiesRequestFilterSensitiveLog, GetWorkflowRunPropertiesResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetWorkflowRunPropertiesCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetWorkflowRunPropertiesCommand.getEndpointParameterInstructions()));
