...
import { UpdateColumnStatisticsForTableRequestFilterSensitiveLog, UpdateColumnStatisticsForTableResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateColumnStatisticsForTableCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateColumnStatisticsForTableCommand.getEndpointParameterInstructions()));
