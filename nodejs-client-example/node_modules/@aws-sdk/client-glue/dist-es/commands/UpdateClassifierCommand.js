...
import { UpdateClassifierRequestFilterSensitiveLog, UpdateClassifierResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateClassifierCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateClassifierCommand.getEndpointParameterInstructions()));
