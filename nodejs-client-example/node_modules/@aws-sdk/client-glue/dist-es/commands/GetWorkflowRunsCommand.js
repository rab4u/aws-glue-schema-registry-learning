...
import { GetWorkflowRunsRequestFilterSensitiveLog, GetWorkflowRunsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetWorkflowRunsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetWorkflowRunsCommand.getEndpointParameterInstructions()));
