...
import { PutSchemaVersionMetadataInputFilterSensitiveLog, PutSchemaVersionMetadataResponseFilterSensitiveLog, } from "../models/models_2";
...
export class PutSchemaVersionMetadataCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, PutSchemaVersionMetadataCommand.getEndpointParameterInstructions()));
