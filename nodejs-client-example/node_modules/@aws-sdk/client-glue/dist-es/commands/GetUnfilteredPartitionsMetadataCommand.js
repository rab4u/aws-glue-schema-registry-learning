...
import { GetUnfilteredPartitionsMetadataRequestFilterSensitiveLog, GetUnfilteredPartitionsMetadataResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetUnfilteredPartitionsMetadataCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetUnfilteredPartitionsMetadataCommand.getEndpointParameterInstructions()));
