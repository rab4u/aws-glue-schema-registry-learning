...
import { StopCrawlerScheduleRequestFilterSensitiveLog, StopCrawlerScheduleResponseFilterSensitiveLog, } from "../models/models_2";
...
export class StopCrawlerScheduleCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, StopCrawlerScheduleCommand.getEndpointParameterInstructions()));
