...
import { GetUserDefinedFunctionsRequestFilterSensitiveLog, GetUserDefinedFunctionsResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetUserDefinedFunctionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetUserDefinedFunctionsCommand.getEndpointParameterInstructions()));
