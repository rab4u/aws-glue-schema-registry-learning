...
import { GetUnfilteredPartitionMetadataRequestFilterSensitiveLog, GetUnfilteredPartitionMetadataResponseFilterSensitiveLog, } from "../models/models_1";
...
export class GetUnfilteredPartitionMetadataCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetUnfilteredPartitionMetadataCommand.getEndpointParameterInstructions()));
