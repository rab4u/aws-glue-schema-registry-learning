...
import { RemoveSchemaVersionMetadataInputFilterSensitiveLog, RemoveSchemaVersionMetadataResponseFilterSensitiveLog, } from "../models/models_2";
...
export class RemoveSchemaVersionMetadataCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, RemoveSchemaVersionMetadataCommand.getEndpointParameterInstructions()));
