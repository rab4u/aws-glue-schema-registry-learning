...
import { DeleteColumnStatisticsForPartitionRequestFilterSensitiveLog, DeleteColumnStatisticsForPartitionResponseFilterSensitiveLog, } from "../models/models_1";
...
export class DeleteColumnStatisticsForPartitionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteColumnStatisticsForPartitionCommand.getEndpointParameterInstructions()));
