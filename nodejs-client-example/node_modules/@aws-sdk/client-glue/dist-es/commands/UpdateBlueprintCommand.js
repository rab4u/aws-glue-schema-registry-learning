...
import { UpdateBlueprintRequestFilterSensitiveLog, UpdateBlueprintResponseFilterSensitiveLog, } from "../models/models_2";
...
export class UpdateBlueprintCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateBlueprintCommand.getEndpointParameterInstructions()));
