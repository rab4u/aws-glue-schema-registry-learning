...
import { ResetJobBookmarkRequestFilterSensitiveLog, ResetJobBookmarkResponseFilterSensitiveLog, } from "../models/models_2";
...
export class ResetJobBookmarkCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, ResetJobBookmarkCommand.getEndpointParameterInstructions()));
