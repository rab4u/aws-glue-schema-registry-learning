...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new ListBlueprintsCommand_1.ListBlueprintsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.listBlueprints(input, ...args);
};
async function* paginateListBlueprints(config, input, ...additionalArguments) {
