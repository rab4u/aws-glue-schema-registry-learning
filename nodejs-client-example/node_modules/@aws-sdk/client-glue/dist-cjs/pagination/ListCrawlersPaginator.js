...
exports.paginateListCrawlers = void 0;
const ListCrawlersCommand_1 = require("../commands/ListCrawlersCommand");
const Glue_1 = require("../Glue");
const GlueClient_1 = require("../GlueClient");
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new ListCrawlersCommand_1.ListCrawlersCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.listCrawlers(input, ...args);
};
async function* paginateListCrawlers(config, input, ...additionalArguments) {
...
exports.paginateListCrawlers = paginateListCrawlers;
