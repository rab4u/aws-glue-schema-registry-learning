...
exports.paginateGetCrawlers = void 0;
const GetCrawlersCommand_1 = require("../commands/GetCrawlersCommand");
const Glue_1 = require("../Glue");
const GlueClient_1 = require("../GlueClient");
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetCrawlersCommand_1.GetCrawlersCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getCrawlers(input, ...args);
};
async function* paginateGetCrawlers(config, input, ...additionalArguments) {
...
exports.paginateGetCrawlers = paginateGetCrawlers;
