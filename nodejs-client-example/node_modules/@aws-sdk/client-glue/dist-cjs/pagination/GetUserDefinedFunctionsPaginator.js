...
exports.paginateGetUserDefinedFunctions = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetUserDefinedFunctionsCommand_1.GetUserDefinedFunctionsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getUserDefinedFunctions(input, ...args);
};
async function* paginateGetUserDefinedFunctions(config, input, ...additionalArguments) {
