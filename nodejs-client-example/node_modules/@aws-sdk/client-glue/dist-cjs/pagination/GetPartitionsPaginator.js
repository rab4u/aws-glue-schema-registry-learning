...
exports.paginateGetPartitions = void 0;
const GetPartitionsCommand_1 = require("../commands/GetPartitionsCommand");
const Glue_1 = require("../Glue");
const GlueClient_1 = require("../GlueClient");
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetPartitionsCommand_1.GetPartitionsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getPartitions(input, ...args);
};
async function* paginateGetPartitions(config, input, ...additionalArguments) {
...
exports.paginateGetPartitions = paginateGetPartitions;
