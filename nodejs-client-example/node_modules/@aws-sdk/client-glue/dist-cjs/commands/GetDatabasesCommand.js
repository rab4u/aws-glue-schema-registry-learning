...
class GetDatabasesCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, GetDatabasesCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.GetDatabasesRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.GetDatabasesResponseFilterSensitiveLog,
        };
