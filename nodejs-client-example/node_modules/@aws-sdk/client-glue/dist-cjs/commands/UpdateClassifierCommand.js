...
class UpdateClassifierCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, UpdateClassifierCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.UpdateClassifierRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.UpdateClassifierResponseFilterSensitiveLog,
        };
