...
class StopTriggerCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, StopTriggerCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.StopTriggerRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.StopTriggerResponseFilterSensitiveLog,
        };
