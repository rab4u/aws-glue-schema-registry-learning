...
class QuerySchemaVersionMetadataCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, QuerySchemaVersionMetadataCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.QuerySchemaVersionMetadataInputFilterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.QuerySchemaVersionMetadataResponseFilterSensitiveLog,
        };
