...
class StartMLEvaluationTaskRunCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, StartMLEvaluationTaskRunCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_2_1.StartMLEvaluationTaskRunRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_2_1.StartMLEvaluationTaskRunResponseFilterSensitiveLog,
        };
