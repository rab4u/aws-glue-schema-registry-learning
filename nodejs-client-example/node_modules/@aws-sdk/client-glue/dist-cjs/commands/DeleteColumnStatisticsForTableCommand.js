...
class DeleteColumnStatisticsForTableCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, DeleteColumnStatisticsForTableCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.DeleteColumnStatisticsForTableRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.DeleteColumnStatisticsForTableResponseFilterSensitiveLog,
        };
